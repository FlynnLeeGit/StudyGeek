...
var tabSwitch = require('./tb'); //引入选项卡模块

x = 0; //定义主轮播动画的x轴偏移量
var schoolX = 7 * 140; //定义合作院校动画的x轴偏移量
...
//轮播箭头点击事件
tabSwitch('.lb-arrow', 'click', function(index) { //调用选项卡函数 事件为单击
...
//轮播选项卡点击事件
tabSwitch('.lb-tabs', 'click', function(index) {
	x = index * 568;
	$('.lb-wrap').animate({
		left: -x
	}, 500);
...
//合作院校箭头点击事件
tabSwitch('.school-arrow', 'click', function(index) {
...
//推荐视频标签页 hover事件
tabSwitch('.main-labels', 'mouseover', function(index) {
...
//侧边菜单hover事件
tabSwitch('.aside', 'mouseover', function(index) {
	var submenuEles = $('.asideSubMenu');
	submenuEles.hide();
	$('.list-more').show(); //内容显示
...
$('.aside').mouseleave(function() {
	$('.asideSubMenu').hide(); //内容隐藏
	$('.list-more').hide(); //三个多的列表隐藏
})

},{"./tb":2,"jquery":3}],2:[function(require,module,exports){
var $=require('jquery');
