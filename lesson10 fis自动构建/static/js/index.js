...
$(document).ready(function() {
	var skinhovertab = new HoverTab(); //换肤按钮效果
	skinhovertab.init({
		btn: '#skinBtn',
		subWrap: '.skin-wrap'
	});

	var settingtab = new HoverTab(); //设置按钮效果
	settingtab.init({
		btn: '#settingBtn',
		subWrap: '.setting'
	});

	var morehovertab = new HoverTab(); //更多按钮效果
	morehovertab.init({
		btn: '#moreBtn',
		subWrap: '.more'
	});

	var accounthovertab = new HoverTab(); //个人中心按钮效果
	...
	skintab.init({
		...
		callback: function(index) { //回调
			var skinimgArr = [__uri('../img/bg/bg1.jpg'), __uri('../img/bg/bg2.jpg'), __uri('../img/bg/bg3.jpg'), __uri('../img/bg/bg4.jpg'), __uri('../img/bg/bg5.jpg')];
	...
	var imgJson = { //图片json对象 用于加载瀑布流
		src: [__uri('../img/pbl/1.png'), __uri('../img/pbl/2.png'), __uri('../img/pbl/3.png'), __uri('../img/pbl/4.png'), __uri('../img/pbl/5.png'), __uri('../img/pbl/6.png'), __uri('../img/pbl/7.png'), __uri('../img/pbl/8.png'), __uri('../img/pbl/9.png'), __uri('../img/pbl/10.png'), __uri('../img/pbl/11.png'), __uri('../img/pbl/12.png'), __uri('../img/pbl/13.png'), __uri('../img/pbl/14.png')],
